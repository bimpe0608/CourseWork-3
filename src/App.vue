...
export default {
    ...
    methods: {
        async fetchLessons() {
            try {
                const response = await fetch('https://vuejsbackend.eu-north-1.elasticbeanstalk.com/lessons');
                if (!response.ok) {
        ...
        async updateLessonSpaces(lessonId, newSpaces) {
            try {
                const response = await fetch(`https://vuejsbackend.eu-north-1.elasticbeanstalk.com/lessons/${lessonId}`, {
                    method: 'PUT',
        ...
        async searchLessons() {
            try {
                ...
                const response = await fetch(`https://vuejsbackend.eu-north-1.elasticbeanstalk.com/lessons?search=${this.searchInput}`);
                this.lessons = await response.json();
            } catch (error) {
                console.error(error);
            }
